package com.uns.api.Empleado.service.serviceImpl;

import com.uns.api.Empleado.entity.Empleado;
import com.uns.api.Empleado.repository.EmpleadoRepository;
...
public class EmpleadoServiceImpl implements EmpleadoService {
	...
	@Override
	public List<Empleado> findEmployees( String filtro ) {
		return empleadoRepository
				.findAll()
				.stream()
				.filter( buscados -> buscados.getNombre().contains( filtro ) )
