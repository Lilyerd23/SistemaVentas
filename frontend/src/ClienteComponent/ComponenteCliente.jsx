import "./styles/componentClient.scss"
                    ...
                    <div className="card">
                        <div className="box tipo">
                            <div className="content">
                                ...
                                <br/>
                                <p>
                                    Acceso a los tipos de clientes, ademas de poder registrar nuevos tipos
                                </p>
                                <br/>
                                <div className="nav_btn">
                                    <i className="icon_options"><FontAwesomeIcon icon={ faFileSignature }/></i>
                                    <a href={ "/view-tipos" } className="btn_acceso btn_T">
                                        <span/>
                                        <span/>
                                        <span/>
                                        <span/>
